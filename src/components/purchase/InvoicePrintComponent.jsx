          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ml-auto">
              ...
              <ReactToPdf
                ...
                filename={`${purchase.InvoiceNumber}.pdf`}
              >
            ...
            <Col>
              <ListGroup variant="flush" className="text-center">
                ...
                <ListGroup.Item className="border-0 p-1">
                  <span>Outlet:</span> <span>{purchase.Outlet.Name}</span>
                </ListGroup.Item>
                <ListGroup.Item className="border-0 p-1">
                  <span>Number:</span> <span>{purchase.Outlet.Number}</span>
                </ListGroup.Item>
                <ListGroup.Item className="border-0 p-1">
                  <span>Email:</span> <span>{purchase.Outlet.Email}</span>
                </ListGroup.Item>
                <ListGroup.Item className="border-0 p-1">
                  <span>Address:</span> <span>{purchase.Outlet.Address}</span>
                </ListGroup.Item>
              </ListGroup>
            </Col>
            <Col>
              <ListGroup variant="flush" className="text-center">
                ...
                <ListGroup.Item className="border-0 p-1">
                  <span>Suplier Id:</span> <span>{purchase.Supplier.id}</span>
                </ListGroup.Item>
                <ListGroup.Item className="border-0 p-1">
                  <span>Invoice No:</span> <span>{purchase.InvoiceNumber}</span>
                </ListGroup.Item>
                <ListGroup.Item className="border-0 p-1">
                  <span>Issue:</span>{" "}
